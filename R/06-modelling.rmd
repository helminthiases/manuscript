...
Whilst $\mathbf{\beta}$ is the vector of the concurrent fixed effects coefficients.  $U_{i}$ are independent Normally distributed random variables; $U_{i} \sim \mathcal{N}(0, \nu^{2})$.
