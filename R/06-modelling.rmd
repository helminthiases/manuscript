...
Whilst $\mathbf{\beta}$ is the vector of the concurrent fixed effects coefficients.  $U_{i}$ are independent Normally distributed random variables; $Z_{i} \sim \mathcal{N}(0, \tau^{2})$.
