...
The empirical variogram of the residuals ...

```{r F0005, fig.pos = 'h!', out.width = '50%', fig.align = 'center', fig.cap = 'The variogram w.r.t. \\textit{Case A}'}
...
```{r F0006, fig.pos = 'h!', out.width = '50%', fig.align = 'center', fig.cap = 'The variogram w.r.t. \\textit{Case B}'}
knitr::include_graphics(
