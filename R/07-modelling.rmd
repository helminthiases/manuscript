...
```{r F0008, fig.pos = 'h!', out.width = '60%', fig.align = 'center', fig.cap = 'The variogram w.r.t. the \\textit{Case A} Binomial Geostatistical Model.'}
...
```{r F0009, fig.pos = 'h!', out.width = '85%', fig.align = 'center', fig.cap = 'Prevalence estimates \\textit{vs.} originals, w.r.t. the \\textit{Case A} Binomial Geostatistical Model.'}
knitr::include_graphics(
