...
DescriptionExtraneous <- function () {
  ...
  descriptions <- c(
    "Percentage (a) \\textit{access to any improved sanitation facility}, and (b) \\textit{reliance on unimproved sanitation facilities}, respectively.",
    "Percentage (a) \\textit{access to sewer and septic sanitation facilities}, and (b) \\textit{access to a non-piped improved sanitation facility}, respectively.",
    "Percentage \\textit{reliance on open defaecation}.",
