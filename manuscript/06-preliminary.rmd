...
estimations$fixed %>%
  ...
  kableExtra::kable(
    ...
    caption = 'The estimated coefficients of the GLMM Model.  $\\eta_{i} = \\beta_{0} + \\beta_{1}{piped\\underline{\\hspace{0.125cm}}sewer}(x_{i}) + \\beta_{2}{piped\\underline{\\hspace{0.125cm}}sewer}(x_{i})^{2} + \\beta_{3}{elevation.km}(x_{i}) + b_{i}$') %>%
  kableExtra::kable_styling(position = 'center', latex_options = 'hold_position', font_size = 7, full_width = FALSE) %>%
...
estimations$fixed %>%
  ...
  kableExtra::kable(
    ...
    col.names = kableExtra::linebreak(c('', 'coef.', 'coef.\nest.',
                                        'lower', 'upper', 's.e.', '$p_{value}$')),
    caption = 'The estimated coefficients of GLMM Model with linear predictor $\\eta_{i} = \\beta_{0} + \\beta_{1}{piped\\underline{\\hspace{0.125cm}}sewer}(x_{i}) + \\beta_{2}{ln(p\\underline{\\hspace{0.125cm}}density.k)}(x_{i}) + \\beta_{3}{elevation.km}(x_{i}) + b_{i}$') %>%
  kableExtra::kable_styling(position = 'center', latex_options = 'hold_position', font_size = 7, full_width = FALSE) %>%
  kableExtra::add_header_above(c('', '', '', 'confidence\ninterval' = 2, '', '')) %>%
  kableExtra::add_footnote(label = c('coef.: coefficient', 'est.: estimate', 's.e.: standard error'), notation = 'none')  %>%
  kableExtra::column_spec(column = 1, italic = TRUE, latex_column_spec = "l") %>%
