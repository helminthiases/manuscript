...
Leading on from the aforementioned preliminary models, with linear predictors \cref{eq:0029,eq:0030}, this section focuses on models with linear predictors
\begin{align}
...
& \quad  + \beta_{3}{elevation.km}(x_{i}) + b_{i} \nonumber
\end{align}
i.e., linear predictors \cref{eq:0029,eq:0030} without a *year* random effects term.
