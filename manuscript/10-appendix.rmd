...
(Institute for Health Metrics and Evaluation) -- **for** determining site level WASH variables values. The [ESPEN estimates](https://espen.afro.who.int/diseases/wash), which depend on the IHME methodology, are implementation level estimates.\newline
* The [National Oceanic & Atmospheric Administration (NOAA)](https://www.ncdc.noaa.gov/cdo-web/datasets), [WorldClim](https://www.worldclim.org/data/index.html), and [DIVA GIS](https://www.diva-gis.org/Data) -- **for** historical geospatial and/or environmental variables values.
...
\begin{tabular}{p{0.25\linewidth}l p{0.5\linewidth}l}\footnotesize
$\;$ & Item \\ \hline
...
$2022/07/12$ - $2022/07/30$ & Exploratory data analysis.{\par}Exploration of geospatial binomial logistic models. \\
$2022/08/01$ - $2022/08/21$ & Final modelling stage; two models at most.{\par}Model validation.{\par}Model testing. \\
