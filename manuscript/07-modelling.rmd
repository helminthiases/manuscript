...
\textsc{textbf{Piped Sewage Facilities}}
...
>
> * Additionally, the standard errors of the Bayesian coefficients estimates $\beta_{1}$ & $\beta_{2}$ - for $piped\underline{\hspace{0.125cm}}sewer$ & $piped\underline{\hspace{0.125cm}}sewer^{2}$, respectively, are relatively quite smaller than the MCML standard errors (\cref{tab:T0011}).
