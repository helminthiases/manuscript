...
Leading on from the data, the exploratory analysis, and the preliminary investigation chapters, a few important points
...
This section explores *geo-statistical binomial logistics models* wherein the parameter estimates are either (a) Monte Carlo Maximum Likelihood estimates, or (b) Bayesian estimates.
