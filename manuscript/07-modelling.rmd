...
\cref{tab:T0011} & \cref{tab:T0043} outline the Monte Carlo Maximum Likelihood (MCML) & Bayesian parameter estimates, respectively, of the Binomial geostatistical model with linear predictor \cref{eq:0040}.  The estimates, partly summarised in \cref{tab:T0060}, are similar but
