...
\textbf{The coefficients estimates} are measures of variable impact ... focusing on the fixed-term effects of \cref{eq:0040}

\begin{equation}
\frac{p(x_{i})}{1 - p(x_{i})} \prop exp^{\beta_{0}}  exp^{\beta_{1}{piped\underline{\hspace{0.125cm}}sewer}(x_{i})}  exp^{\beta_{2}{piped\underline{\hspace{0.125cm}}sewer}(x_{i})^{2}} exp^{\beta_{3}{elevation.km}(x_{i})}  (\#eq:0047)
\end{equation}

by \cref{eq:0037,eq:0038,eq:0039,eq:0040}
