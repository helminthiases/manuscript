...
\end{align}
in acknowledgement of the fact that the project's focus is Binomial models.  The fitted lines are for pattern investigation purposes, and the fitting functions, throughout this chapter, are **(a)** dashed lines: $y = mx + c$, and **(b)** solid lines: cubic splines.
