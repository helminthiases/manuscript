...
An option, in place of expensive field surveys, is INI prevalence predictions.  Prediction model development depends on probable risk factors knowledge & understandings (@Murray2020).   In relation to geohelminths infections, WaSH (water, sanitation, and hygiene) variables are amongst the sets of probable risk factors (@Albonico2006).  However, although there have been a few studies suggesting WaSH variables are geohelminths infections risk factors, the evidence is contentious (@Garn2022, @Freeman2017,  @Strunz2014).  This project investigates the possibility that one or more WaSH variables are geohelminths infections risk factors.
